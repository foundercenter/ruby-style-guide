# Internal Ruby Style Guide

**KEEP IN MIND THIS IS A PUBLIC REPOSITORY**

Derived from the community-driven [Ruby Style Guide](https://github.com/bbatsov/ruby-style-guide).

Work in progress (both the style guide, and adapting the guidelines).
...
Check out the complementary [Ruby on Rails Style Guide][rails-style-guide].
